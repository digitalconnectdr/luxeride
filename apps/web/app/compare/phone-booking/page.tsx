...
const SLUG = '/compare/phone-booking'

export async function generateMetadata(): Promise<Metadata> {
  const t = getDict(getLocale()).comparePages.phoneBooking
...
export default function PhoneBookingComparePage() {
  const locale = getLocale()
  const dict = getDict(locale)
  const content = dict.comparePages.phoneBooking
  const baseUrl = getAppUrl()
