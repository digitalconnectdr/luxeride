...
const SLUG = '/solutions/affiliate-overflow-network'

export async function generateMetadata(): Promise<Metadata> {
  const t = getDict(getLocale()).solutionPages.affiliateOverflowNetwork
...
export default function AffiliateOverflowNetworkSolutionPage() {
  const locale = getLocale()
  const dict = getDict(locale)
  const content = dict.solutionPages.affiliateOverflowNetwork
  const baseUrl = getAppUrl()
