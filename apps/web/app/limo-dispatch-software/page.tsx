...
const SLUG = '/limo-dispatch-software'

export async function generateMetadata(): Promise<Metadata> {
  const t = getDict(getLocale()).moneyPages.limoDispatchSoftware
...
export default function LimoDispatchSoftwarePage() {
  const locale = getLocale()
  const dict = getDict(locale)
  const content = dict.moneyPages.limoDispatchSoftware
  const baseUrl = getAppUrl()
