...
const SLUG = '/chauffeur-software'

export async function generateMetadata(): Promise<Metadata> {
  const t = getDict(getLocale()).moneyPages.chauffeurSoftware
...
export default function ChauffeurSoftwarePage() {
  const locale = getLocale()
  const dict = getDict(locale)
  const content = dict.moneyPages.chauffeurSoftware
  const baseUrl = getAppUrl()
