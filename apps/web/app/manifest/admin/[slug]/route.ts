// ── Manifest PWA del back-office (panel admin), branded por empresa ──────────
// El dueño/staff instala "su panel" con el logo y color de SU empresa —
// mismo patrón que /manifest/[slug] (pasajero) y /manifest/driver/[slug]
// (conductor). Keyed por slug para que el fetch no dependa de cookies.
...
export async function GET(_req: Request, { params }: { params: { slug: string } }) {
  ...
  const manifest = {
    ...
    background_color: '#f6f4ef', // tema Ivory del panel admin
