...
const SLUG = '/limo-software'

export async function generateMetadata(): Promise<Metadata> {
  const t = getDict(getLocale()).moneyPages.limoSoftware
...
export default function LimoSoftwarePage() {
  const locale = getLocale()
  const dict = getDict(locale)
  const content = dict.moneyPages.limoSoftware
  const baseUrl = getAppUrl()
