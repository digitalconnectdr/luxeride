...
// Página del landing con el idioma fijo en inglés (no depende de la cookie),
// para que Google pueda indexarla como una URL propia y citarla via hreflang.

const t = getDict('en').landing

export const metadata: Metadata = {
  title: { absolute: `${brand.name} | ${t.metaTitle} | by ${brand.poweredBy}` },
  description: t.metaDescription,
  alternates: { canonical: '/en', languages: HREFLANG_LANGUAGES },
}

export default function EnglishLandingPage() {
  return <LandingPageContent locale="en" localizedPaths={LOCALE_PATHS} />
}
