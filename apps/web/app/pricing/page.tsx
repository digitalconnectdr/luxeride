          ...
          <RevealStagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
            {l.plans.map((plan, i) => {
              ...
              {/* "Platform fee: X%" ya vive en plan.features (dato real, no
                  ...
                  económico concreto de subir de plan. Es la única línea con
                  "%" en cada plan, así que detectarla por eso funciona igual
                  en los 3 idiomas sin hardcodear el prefijo en inglés. */}
