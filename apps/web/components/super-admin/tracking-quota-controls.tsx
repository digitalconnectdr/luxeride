...
import { updatePlanQuotaAction, updatePlanPriceAction, updateFlightTrackingQuotaAction } from '@/app/actions/companies'
import type { CompanyPlan } from '@/lib/supabase/database.types'

export function FlightQuotaInput({
  plan,
  current,
}: {
  plan: CompanyPlan
  ...
  function save() {
    ...
    startTransition(async () => {
      const result = await updateFlightTrackingQuotaAction(plan, quota)
