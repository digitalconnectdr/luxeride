    ...
    return (
      <li className="p-4 bg-sl-bg/40">
        <form onSubmit={handleSave} className="flex flex-wrap gap-2 items-end">
          <div className="w-16">
            <label className="block text-[10px] uppercase tracking-wider text-sl-on-surface-muted">{t.serviceIconLabel}</label>
            <input name="icon" defaultValue={service.icon ?? ''} maxLength={8} className={`${inputCls} w-full text-center`} />
          </div>
          ...
          <div className="flex-1 min-w-[200px]">
            <label className="block text-[10px] uppercase tracking-wider text-sl-on-surface-muted">{t.serviceDescLabel}</label>
...
export function ServicesManager({
  ...
  return (
    <section className="bg-sl-surface border border-sl-outline-variant rounded-xl p-6">
      ...
      {/* Crear servicio */}
      <form ref={formRef} onSubmit={handleCreate} className="flex flex-wrap gap-2 items-end mb-5">
        <div className="w-16">
          <label className="block text-[10px] uppercase tracking-wider text-sl-on-surface-muted mb-1">{t.serviceIconLabel}</label>
          <input name="icon" placeholder="✈️" maxLength={8} className={`${inputCls} w-full text-center`} />
        </div>
        <div className="flex-1 min-w-[160px]">
