  ...
  admin: {
    ...
    marketplace: {
      ...
      items: {
        ...
        custom_domain: {
          name: 'Custom Domain',
          shortDesc: 'Your booking site on your own domain instead of getluxeride.vercel.app | a more professional, memorable link for your clients.',
          features: [
            'Connect a domain you already own — we verify it and point your booking site to it automatically.',
            'Don\'t have a domain yet? Request one and we\'ll purchase and set it up for you.',
            'Your booking page keeps working exactly the same, only the address changes.',
          ],
          usage: 'Once active, a new "Custom Domain" page appears under Administration. If you already own a domain, add it there and follow the DNS instructions shown | if you don\'t, request one and our team will handle the purchase and setup.',
        },
      },
    },
    help: {
    ...
    domain: {
      ...
      addonTitle: 'Custom Domain add-on',
      addonBody: 'Connect a domain you already own, or request one and we\'ll purchase and set it up for you.',
