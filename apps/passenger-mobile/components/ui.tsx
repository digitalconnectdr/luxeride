...
// Mismas primitivas que apps/driver-mobile/components/ui.tsx (Card, Button,
// StatusBadge, EmptyState, ScreenLoader) adaptadas al tema claro de esta
...
export function StatusBadge({ status }: { status: BookingStatus | string }) {
  ...
  return (
    <View style={[badgeStyles.base, { backgroundColor: `${tint}18`, borderColor: `${tint}40` }]}>
